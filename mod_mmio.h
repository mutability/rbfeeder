...
static int mmio_init(struct mmio *mo)
{
	char *device;
	int iofd;
	...
	if (iofd < 0)
	{
		printf("open failed-11111111111111111111111111111111111111111111111111111111111111111111111\n");
                close(iofd);
                return 0;
	}
	...
	{
		printf("can't map-11111111111111111111111111111111111111111111111111111111111111111111111111\n");
                close(iofd);
                return 0;
	} else {
            close(iofd);
