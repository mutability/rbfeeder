To compile this program, you must define the following variables:
CONN_KEY, CONN_NONCE and DEF_XOR_KEY.

Example: 
$ CONN_KEY=\"abc\" CONN_NONCE=\"xyz\" DEF_XOR_KEY=\"1234\" make -j 4
